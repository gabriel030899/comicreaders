export const products = [
    ...
    },
    {
        ...
        trendingBook: "",
        itemType: "book",
        genre: ["biografia", "arte", "cinema", "fotografia"],
        newcome: "",
        format: "",
        language: "portugues",
        priceRange: "",
    ...
    },
    {
        ...
        trendingBook: true,
        itemType: "book",
        genre: ["ficcao cientifica", "viagem no tempo", "aventura"],
        newcome: "",
        format: "Capa Comum",
        language: "portugues",
        priceRange: "",
    ...
    },
    {
        ...
        trendingBook: true,
        itemType: "book",
        genre: ["romance", "romance para jovens"],
        newcome: "",
        format: "Capa Comum",
        language: "portugues",
        priceRange: "",
    ...
    },
    {
        ...
        trendingBook: "",
itemType: "book",
        genre: ["aventura", "ficcao", "jogos vorazes"],
        newcome: "",
        format: "Capa Comum",
        language: "portugues",
        priceRange: "",
    ...
    },
    {
        ...
        trendingBook: "",
        itemType: "book",
        genre: ["autoajuda", "bem estar", "saude"],
        newcome: "",
        format: "Capa Comum",
        language: "portugues",
        priceRange: "",
    ...
    },
    {
        ...
        trendingBook: "",
itemType: "book",
        genre: ["aventura","ficcao cientifica", "distopico"],
        newcome: "",
        format: "",
        language: "portugues",
        priceRange: "",
    ...
    },
    {
        ...
        trendingBook: "",
itemType: "book",
        genre: ["suspense", "misterios", "thriller"],
        newcome: "",
        format: "Capa Comum",
        language: "portugues",
        priceRange: "",
    ...
    },
    {
        ...
        trendingBook: "",
itemType: "book",
        genre: ["suspense","thriller", "misterio"],
        newcome: "",
        format: "Capa Comum",
        language: "portugues",
        priceRange: "",
    ...
    },
    {
        ...
        Uma garota.
        Dois vilões.
        E a mortal batalha por um felizes para sempre!
        
        Ao se aventurar pelo Magnifico Norte, Evangeline Raposa continuava em busca de seu final feliz. Após acordar sem se recordar do passado, ela se vê casada com Apollo e o lendário castelo do príncipe é, aparentemente, sua nova morada.
        
        Porém, para viver esse suposto conto de fadas, Evangeline precisou pagar um preço devastador sem nem ao menos fazer ideia disso. Ela desconhece tudo aquilo que perdeu, e se depender de seu marido… a jovem nunca descobrirá. Ele está tão determinado a garantir a ignorância de sua esposa que pretende dar um fim à vida de Jacks – o Príncipe de Copas.
        
        Com sangue sendo derramado e corações sendo usurpados, o verdadeiro amor vai ser colocado à prova no último livro da trilogia Era uma vez um coração partido. A maldição do verdadeiro amor é a aguardada conclusão desta história encantadora que arrebatou corações ao redor do mundo.`
    },
    {
...
itemType: "book",
        ...
        Merit Voss está cansada de guardar os segredos de sua família e decide que chegou a hora de desaparecer. Mas antes de sumir do mapa, ela vai revelar um por um, tudo que a família vem guardando por anos.
        ...
        Mas seu plano de revelar a verdade não sai como o esperado e ela deve decidir se pode dar uma segunda chance não apenas à sua família, mas também a si mesma. As mil partes do meu coração mostra que nunca é tarde para perdoar e que não existe família perfeita, por mais branca que seja a cerca.`
    },
    {
    ...
    },
    {
        ...
        trendingBook: "",
itemType: "book",
        genre: ["autoajuda", "inteligencia emocional"],
        newcome: "",
        format: "Capa Comum",
        language: "portugues",
        priceRange: "",
    ...
    },
    {
        ...
        Quando o pioneiro motivacional Napoleon Hill e o CEO milionário W. Clement Stone se uniram para formar uma das parcerias mais notáveis de todos os tempos, o resultado foi Atitude Mental Positiva, o fenômeno editorial que sugeriu ao mundo que, com a atitude certa, qualquer um pode realizar seus sonhos.
        
        "Há muitos anos, devido à minha própria estupidez e defeitos, perdi tudo o que era precioso para mim. Passei muito tempo em bibliotecas públicas porque tinham entrada franca — e eram aquecidas. Li tudo, de Platão a Peale, buscando uma mensagem que pudesse explicar onde eu tinha errado — e o que eu poderia fazer para salvar o resto da minha vida. Finalmente encontrei minha resposta em Atitude Mental Positiva, de Napoleon Hill e W. Clement Stone. (…) De um vagabundo sem dinheiro e sem uma única raiz, acabei me tornando o presidente de duas corporações e editor-executivo da Success Unlimited, a melhor revista do mundo na sua categoria. Também escrevi seis livros, e um deles, O maior vendedor do mundo, traduzido em quatorze idiomas e com mais de três milhões de cópias vendidas. Nada disso teria sido alcançado sem a aplicação diária dos princípios de sucesso e de vida que encontrei neste clássico." — Og Mandino`
    },
    {
    ...
    },
    {
        ...
        trendingBook: "",
        itemType: "book",
        genre: ["biografia","kpop","arte","musica","danca"],
        newcome: "",
        format: "Box e Kits",
        language: "portugues",
        priceRange: "",
        ...
        Após terem se apresentado ao mundo pela primeira vez em 13 de junho de 2013, o BTS celebra 10 anos de aniversário do seu debut em 2023. Eles alcançaram o auge como artistas globais e icônicos e, neste momento significativo, o grupo reflete sobre toda a trajetória percorrida neste primeiro livro oficial. Ao fazer isso, o BTS promove a possibilidade de construir dias melhores, fazendo a escolha de dar mais um passo em uma estrada que ninguém jamais percorreu.
        
        BTS compartilha histórias pessoais e dos bastidores da sua jornada até aqui por meio de entrevistas e mais de três anos de pesquisa e acompanhamento da banda feitos por Myeongseok Kang, que já escreveu para diversas plataformas de mídia sobre K-pop e cultura coreana. Apresentado cronologicamente em sete capítulos, o livro abrange o perído desde antes do debut do BTS até o presente, e suas impactantes vozes e opiniões se combinam para contar uma história honesta, empolgante e profunda. Em entrevistas individuais que foram conduzidas sem câmeras ou maquiagem, eles trazem à luz sua jornada musical por diversos ângulos, discutindo seu impacto.
        
        Além disso, o livro abre com fotos-retrato que mostram o BTS como indivíduos e artistas, e no decorrer das páginas há concept photos, tracklists de todos os álbuns já lançados e mais de 330 QR codes. Como artistas digitais, o BTS se comunicou mundo afora através da internet, e este livro possibilita que os leitores tenham acesso imediato a trailers, clipes e mais conteúdos on-line que oferecem uma compreensão profunda dos momentos-chave da história do BTS. Incluindo uma linha do tempo de todos os principais feitos, BEYOND THE STORY é um incrível acervo — absolutamente tudo sobre o BTS em um único lugar.`
    },
    {
        title: "Bíblia Sagrada Acf",
        image: "books/bibliasagradaacf-thomasnelsonbrasil.jpg",
        author: "Thomas Nelson",
        link: "https://amzn.to/3QHwK1N",
        topSeller: false,
        trendingBook: "",
itemType: "book",
        genre: ["religiao","biblia","texto sagrado"],
        newcome: "",
        format: "Capa Comum",
        language: "portugues",
        priceRange: "",
        ...
        A linguagem dessa bíblia é a Almeida Corrigida Fiel (ACF) conhecida por ser uma tradução clássica que preserva toda a tradição de João Ferreira de Almeida. Com base nisso, foram usados os melhores avanços em tipografia para desenvolver a Fonte Leitura Perfeita, que é exclusivo da Thomas Nelson e reflete esse rico legado de ter um texto fiel aos originais, autoritativo e embasado nos manuscritos mais confiáveis. O resultado é uma letra exclusiva, clara e legível em qualquer tamanho.
        
        Características:
        
        Texto na tradução ACF (Almeida Corrigida Fiel)
        Capa em courosoft (PU)
        Folhas de guarda sofisticadas
        Base interna de látex para maior durabilidade e flexibilidade
        Costura perimetral (costura de linha "ao redor da borda da capa")
        Pintura Trilateral
        Fitilho colorido
        Fonte Leitura Perfeita
        Letra tamanho grande
        Lombada costurada para total abertura`
    },
    {
        title: "Café com Deus Pai: Porções Diárias de Renovação",
        image: "books/cafecomdeuspai-juniorrostirola.jpg",
        author: "Júnior Rostirola",
        link: "https://amzn.to/3u3jX0p",
        topSeller: false,
        trendingBook: true,
itemType: "book",
        genre: ["religiao","bem estar","inteligencia emocional"],
        newcome: "",
        format: "Capa Comum",
        language: "portugues",
        priceRange: "",
    ...
    {
        title: "CALAFRIOS: Seleção de contos favoritos de Junji Ito",
        image: "books/calafrios-junjiito.jpg",
        author: "Junji Ito",
        link: "https://amzn.to/46R2BCA",
        topSeller: false,
        trendingBook: "",
itemType: "book",
        genre: "manga",
    ...
    },
    {
        ...
        image: "books/chainsawmanvol1-tatsukifujimoto.jpg",
        author: "Tatsuki Fujimoto",
        link: "https://amzn.to/3tThTYZ",
        topSeller: false,
        trendingBook: "",
        itemType: "book",
        genre: ["hq","manga","anime"],
        newcome: "",
        format: "Capa Comum",
        language: "portugues",
        priceRange: "",
    ...
    },
    {
        ...
        image: "books/domilaomilhao-thiagonigro.jpg",
        author: "Thiago Nigro",
        link: "https://amzn.to/3FIcPJO",
        topSeller: false,
        trendingBook: "",
        itemType: "book",
        genre: ["financeiro","negocios","business","economia"],
        newcome: "",
        format: "Capa Comum",
        language: "portugues",
        priceRange: "",
    ...
    },
    {
        ...
        image: "books/eassimqueacaba-colleenhoover.jpg",
        author: "Colleen Hoover",
        link: "https://amzn.to/40oLJ3U",
        topSeller: false,
        trendingBook: true,
        itemType: "book",
        genre: ["romance","tiktok"],
        newcome: "",
        format: "Capa Comum",
        language: "portugues",
        priceRange: "",
    ...
    {
        title: "Elon Musk",
        image: "books/elonmusk-walterisaacson.jpg",
        author: "Walter Isaacson",
        link: "https://amzn.to/45YPApn",
        topSeller: false,
        trendingBook: "",
        itemType: "book",
        genre: ["biografia", "milionario"],
        newcome: "",
        format: "Capa Comum",
        language: "portugues",
        priceRange: "",
    ...
    },
    {
        ...
        image: "books/embuscademim-violadavis.jpg",
        author: "Viola Davis",
        link: "https://amzn.to/49lWhF1",
        topSeller: false,
        trendingBook: "",
        itemType: "book",
        genre: ["biografia","arte","cinema"],
        newcome: "",
        format: "Capa Comum",
        language: "portugues",
        priceRange: "",
    ...
    {
        title: "Era uma vez um coração partido (Sucesso do TikTok)",
        image: "books/eraumavezumcoracaopartido-stephaniegarber.jpg",
        author: "Stephanie Garber",
        link: "https://amzn.to/3MpJoQo",
        topSeller: false,
        trendingBook: true,
        itemType: "book",
        genre: ["romance","magia","fantasia", "tiktok"],
        newcome: "",
        format: "Box e Kits",
        language: "portugues",
        priceRange: "",
    ...
    {
        title: "Essencialismo: A disciplina busca por menos",
        image: "books/essencialismo-gregmckeown.jpg",
        author: "Greg McKeown",
        link: "https://amzn.to/3Msf2MZ",
        topSeller: false,
        trendingBook: "",
itemType: "book",
        genre: ["autoajuda", "inteligencia emocional"],
    ...
    {
        title: "Filho do Hamas",
        image: "books/filhodohamas-mosabhassanyousef.jpg",
        author: "Mosab Hassan Yousef",
        link: "https://amzn.to/3Mq4j5G",
        topSeller: false,
        trendingBook: "",
itemType: "book",
        genre: ["biografia", "historia", "nao ficcao"],
        newcome: "pre-venda",
        format: "Capa Comum",
        language: "portugues",
        priceRange: "",
...
itemType: "book",
    ...
    },
    {
        ...
        trendingBook: "",
        itemType: "book",
        genre: ["autoajuda","reflexao", "inteligencia emocional"],
        newcome: "",
        format: "Box e Kits",
        language: "portugues",
        priceRange: "",
...
itemType: "book",
    ...
    },
    {
        ...
        trendingBook: "",
itemType: "book",
        genre: ["suspense", "thriller", "misterio", "lady killers 13"],
        newcome: "",
        format: "Capa Dura",
        language: "portugues",
        priceRange: "",
...
itemType: "book",
    ...
    },
    {
        ...
        trendingBook: "",
itemType: "book",
        genre: ["biografia", "lider", "pessoas notaveis","nao ficcao"],
        newcome: "",
        format: "Capa Comum",
        language: "portugues",
        priceRange: "",
...
itemType: "book",
    ...
    },
    {
        ...
        trendingBook: "",
itemType: "book",
        genre: ["autoajuda","psicologia", "inteligencia emocional", "boa forma", "saude"],
        newcome: "",
        format: "Capa Comum",
        language: "portugues",
        priceRange: "",
...
itemType: "book",
    ...
    },
    {
        ...
        image: "books/amigosamoreseaquelacoisaterrivel - mathewperry.jpg",
        author: "Mathew Perry",
        link: "https://amzn.to/3skVljq",
        topSeller: false,
        trendingBook: true,
        itemType: "book",
        genre: "biografia",
        ...
        classification: "4,7",
        specialCategory: [""], 
        description: `O amado astro de Friends nos conduz aos bastidores dessa série de sucesso e narra a luta que enfrentou contra o vício neste sincero livro de memórias. Divertido e revelador, Amigos, Amores e Aquela Coisa Terrível traz uma poderosa mensagem de esperança e resiliência.
    ...
    },
    {
        ...
        classification: "4,7",
        specialCategory: [""], 
        description: `Emocionante e inesquecível, aguardado livro de Adam Silvera chega ao Brasil em outubro
    ...
    },
    {
        ...
        image: "books/harrypotterpedrafilosofal-jkrowling.jpg",
        author: "J.K. Rowling",
        link: "https://amzn.to/3QN4MkW",
        topSeller: false,
        trendingBook: false,
        itemType: "book",
        genre: ["aventura","magia", "fantasia", "bruxos", "bruxas"],
        newcome: "",
        format: "Capa Dura",
        language: "portugues",
        priceRange: "",
    ...
    },
    {
        ...
        image: "books/harrypottercamarasecreta-jkrowling.jpg",
        author: "J.K. Rowling",
        link: "https://amzn.to/3QOvwBF",
        topSeller: false,
        trendingBook: false,
        itemType: "book",
        genre: ["aventura","magia", "fantasia", "bruxos", "bruxas"],
    ...
    },
    {
        ...
        image: "books/harrypotterprisioneiroazkaban-jkrowling.jpg",
        author: "J.K. Rowling",
        link: "https://amzn.to/49sbBzW",
        topSeller: false,
        trendingBook: false,
        itemType: "book",
        genre: ["aventura","magia", "fantasia", "bruxos", "bruxas"],
    ...
    },
    {
        ...
        image: "books/harrypottercalicedefogo-jkrowling.jpg",
        author: "J.K. Rowling",
        link: "https://amzn.to/3u0n2yl",
        topSeller: false,
        trendingBook: false,
        itemType: "book",
        genre: ["aventura","magia", "fantasia", "bruxos", "bruxas"],
    ...
    },
    {
        ...
        image: "books/harrypotterordemdafenix-jkrowling.jpg",
        author: "J.K. Rowling",
        link: "https://amzn.to/3QRomNi",
        topSeller: false,
        trendingBook: false,
        itemType: "book",
        genre: ["aventura","magia", "fantasia", "bruxos", "bruxas"],
    ...
    },
    {
        ...
        image: "books/harrypotterenigmadoprincipe-jkrowling.jpg",
        author: "J.K. Rowling",
        link: "https://amzn.to/3SNS9rB",
        topSeller: false,
        trendingBook: false,
        itemType: "book",
        genre: ["aventura","magia", "fantasia", "bruxos", "bruxas"],
    ...
    },
    {
        ...
        image: "books/harrypotterreliquiasdamorte-jkrowling.jpg",
        author: "J.K. Rowling",
        link: "https://amzn.to/3SNS9rB",
        topSeller: false,
        trendingBook: false,
    ...
    },
    {
        ...
        image: "books/senhordosaneis-jrrtolkien.jpg",
        author: "J. R. R. Tolkien",
        link: "https://amzn.to/46TpcOZ",
        topSeller: false,
        trendingBook: false,
        itemType: "book",
        genre: ["aventura","magia", "fantasia", "bruxos", "bruxas"],
    ...
    },
    {
        ...
        image: "books/osilmarillion-jrrtolkien.jpg",
        author: "J. R. R. Tolkien",
        link: "https://amzn.to/49BLgj0",
        topSeller: false,
        trendingBook: false,
        itemType: "book",
        genre: ["aventura","magia", "fantasia", "bruxos", "bruxas"],
    ...
    },
    {
        ...
        image: "books/percyjacksonolimpianos-rickriordan.jpg",
        author: "Rick Riordan",
        link: "https://amzn.to/40rkZjc",
        topSeller: false,
        trendingBook: false,
        itemType: "book",
        genre: ["aventura","magia", "fantasia", "grecia", "mitologia grega"],
        newcome: "",
        format: "Box e Kits",
        language: "portugues",
        priceRange: "",
        ...
        O Mar de Monstros, quando ele e seus amigos se envolvem numa perigosa aventura para defender o Acampamento Meio-Sangue;
        
        A maldição do Titã, em que nosso herói descobre que Cronos, o Senhor dos Titãs, despertou e está disposto a destruir toda a humanidade;
        
        A batalha do Labirinto, em que Percy, Tyson, Annabeth e Grover são destacados para combater o perigoso Titã nos corredores do temido Labirinto de Dédalo;
        
        O último Olimpiano, quando o confronto toma as ruas de Nova York e Percy tem de lidar não só com o exército de Cronos, mas também com a chegada de seu 16º aniversário e, com ele, com a profecia que determinará seu destino.`
    },
    {
        title: "Box Especial Trilogia Jogos Vorazes",
        image: "books/jogosvorazes-suzzanecollins.jpg",
        author: "Suzzane Collins",
        link: "https://amzn.to/3FVdA1T",
        topSeller: false,
        trendingBook: false,
        itemType: "book",
        genre: ["aventura", "fantasia", "acao", "sobrevivencia"],
        newcome: "",
        format: "Box e Kits",
        language: "portugues",
        priceRange: "",
        ...
        Em chamas
        Depois dos últimos Jogos Vorazes, algo parece ter mudado para sempre em Panem. Aqui e ali, distúrbios e agitações nos distritos dão sinais de que uma revolta é iminente.
        
        A esperança
        A coragem de Katniss nos jogos fez nascer a esperança em um país disposto a fazer de tudo para se livrar da opressão. E agora, contra a própria vontade, ela precisa assumir seu lugar como símbolo da causa rebelde. Ela precisa virar o Tordo.
        
        A trilogia Jogos Vorazes foi adaptada para o cinema e estrelada por Jennifer Lawrence.`
    },
    {
        title: "Duna (Crônicas de Duna Livro 1)",
        image: "books/dunavol1-frankherbet.jpg",
        author: "Frank Herbert",
        link: "https://amzn.to/3sfkqMN",
        topSeller: false,
        trendingBook: false,
        itemType: "book",
        genre: ["aventura", "acao", "fantasia"],
        newcome: "",
        format: "Capa Comum",
        language: "portugues",
        priceRange: "",
    ...
    {
        title: "Messias de Duna (Crônicas de Duna Livro 2)",
        image: "books/dunavol2-frankherbet.jpg",
        author: "Frank Herbert",
        link: "https://amzn.to/40rlXMm",
        topSeller: false,
        trendingBook: false,
        itemType: "book",
        genre: ["aventura", "acao", "fantasia"],
    ...
    {
        title: "Filhos de Duna (Crônicas de Duna Livro 3)",
        image: "books/duna-frankherbert.jpg",
        author: "Frank Herbert",
        link: "https://amzn.to/3Mz3mbc",
        topSeller: false,
        trendingBook: false,
        itemType: "book",
        genre: ["aventura", "acao", "fantasia"],
    ...
    {
        title: "Imperador Deus de Duna (Crônicas de Duna Livro 4)",
        image: "books/dunavol4-frankherbert.jpg",
        author: "Frank Herbert",
        link: "https://amzn.to/47nnoO8",
        topSeller: false,
        trendingBook: false,
        itemType: "book",
        genre: ["aventura", "acao", "fantasia"],
    ...
    },
    {
        ...
        image: "books/dunavol5-frankherbert.jpg",
        author: "Frank Herbert",
        link: "https://amzn.to/3SBCprz",
        topSeller: false,
        trendingBook: false,
        itemType: "book",
        genre: ["aventura", "acao", "fantasia"],
    ...
    {
        title: "Herdeiras de Duna",
        image: "books/dunavol6-frankherbert.jpg",
        author: "Frank Herbert",
        link: "https://amzn.to/47k2LlO",
        topSeller: false,
        trendingBook: false,
        itemType: "book",
        genre: ["aventura", "acao", "fantasia"],
    ...
    },
    {
        ...
        image: "books/kimjiyoung-chonamjoo.jpg",
        author: "Cho Nam-Joo",
        link: "https://amzn.to/40xE3MO",
        topSeller: false,
        trendingBook: false,
        itemType: "book",
        genre: ["realidade", "desigualdade", "biografia"],
        newcome: "",
        format: "Capa Comum",
        language: "portugues",
        priceRange: "",
        ...
        classification: "4,6",
        specialCategory: [""], 
        description: `Com narrativa sutil e ao mesmo tempo arrebatadora, Kim Jiyoung, nascida em 1982 retrata a realidade de uma jovem coreana e os profundos impactos da desigualdade de gênero na vida das mulheres
    ...
    {
        title: "O olho mais azul (Nova edição)",
        image: "books/oolhomaisazul-tonimorrison.jpg",
        author: "Toni Morrison",
        link: "https://amzn.to/3FSFV9j",
        topSeller: false,
        trendingBook: false,
        itemType: "book",
        genre: ["preconceito", "romance", "realidade", "desigualdade"],
        newcome: "",
        format: "Capa Comum",
        language: "portugues",
        priceRange: "",
        ...
        classification: "4,7",
        specialCategory: [""], 
        description: `Uma tentativa de dramatizar a opressão que o preconceito racial pode causar na mais vulnerável das criaturas: uma menina negra.
    ...
    {
        title: "Cartas Para A Minha Mae",
        image: "books/cartasparaminhamae-teresacardenas.jpg",
        author: "Teresa Cardenas",
        link: "https://amzn.to/47pwzNQ",
        topSeller: false,
        trendingBook: false,
        itemType: "book",
        genre: ["drama", "emocionante"],
        newcome: "",
        format: "Capa Comum",
        language: "portugues",
        priceRange: "",
    ...
    },
    {
        ...
        image: "books/capitaesdaareia-jorgeamado.jpg",
        author: "Jorge Amado",
        link: "https://amzn.to/3QNWVnf",
        topSeller: false,
        trendingBook: false,
        itemType: "book",
        genre: ["aventura", "realidade", "nacional", "brasil","sobrevivencia"],
        newcome: "",
        format: "Capa Comum",
        language: "portugues",
        priceRange: "",
    ...
    {
        title: "Vidas secas",
        image: "books/vidassecas-gracilianoramos.jpg",
        author: "Graciliano Ramos",
        link: "https://amzn.to/47lLlFA",
        topSeller: false,
        trendingBook: false,
        itemType: "book",
        genre: ["classico", "nacional", "brasil", "realidade"],
        newcome: "",
        format: "Capa Comum",
        language: "portugues",
        priceRange: "",
    ...
    },
    {
        ...
        image: "books/omeupedelaranjalima-josemaurodevasconcelos.jpg",
        author: "Jose Mauro de Vasconcelos",
        link: "https://amzn.to/47kqlPp",
        topSeller: false,
        trendingBook: false,
        itemType: "book",
        genre: ["classico", "biografia", "autobiografia"],
        newcome: "",
        format: "Capa Comum",
        language: "portugues",
        priceRange: "",
    ...
    },
    {
        ...
        image: "books/pessoasnormais-sallyrooney.jpg",
        author: "Sally Rooney",
        link: "https://amzn.to/3FP4Ryl",
        topSeller: false,
        trendingBook: false,
        itemType: "book",
        genre: ["romance", "millennial", "romance para jovens"],
        newcome: "",
        format: "Capa Comum",
        language: "portugues",
        priceRange: "",
        ...
        classification: "4,5",
        specialCategory: [""], 
        description: `Uma história única e envolvente sobre dois jovens que devem enfrentar a eletricidade do primeiro amor em meio às sutilezas das classes sociais e dos problemas familiares. Sally Rooney é a voz da geração millennial.
    ...
    {
        title: "O Último Desejo: A Saga do Bruxo Geralt de Rívia",
        image: "books/oultimodesejo-andrzejsapkowski.jpg",
        author: "Andrzej Sapkowski",
        link: "https://amzn.to/3MBbyYM",
        topSeller: false,
        trendingBook: false,
        itemType: "book",
    ...
    },
    {
        ...
        image: "books/assassinscreed-oliverbowden.jpg",
        author: "Oliver Bowden",
        link: "https://amzn.to/47638Rk",
        topSeller: false,
        trendingBook: false,
        itemType: "book",
        genre: ["acao", "historico", "jogos", "games"],
        newcome: "",
        format: "Capa Comum",
        language: "portugues",
        priceRange: "",
        ...
        classification: "4,7",
        specialCategory: ["gaming"], 
        description: `Traído pelas famílias que governam as cidades-estado italianas, um jovem embarca em uma jornada épica em busca de vingança. Para erradicar a corrupção e restaurar a honra de sua família, ele irá aprender a Arte dos Assassinos.

        Ao longo do caminho, Ezio terá de contar com a sabedoria de grandes mentores, como Leonardo da Vinci e Nicolau Maquiavel, sabendo que sua sobrevivência depende inteiramente de sua perícia e habilidade. Para os aliados, Ezio se tornará uma força de mudança, lutando por liberdade e justiça. Para os inimigos, ele se tornará uma ameaça, dedicado de corpo e alma à destruição dos tiranos que oprimem o povo italiano. Assim começa uma épica história de poder, vingança e conspiração.
    ...
    {
        title: "Metro 2033",
        image: "books/metro2033-dmitryglukhovsky.jpg",
        author: "Dmitry Glukhovsky",
        link: "https://amzn.to/464erbj",
        topSeller: false,
        trendingBook: false,
        itemType: "book",
        genre: ["acao", "suspense", "apocalipse", "sobrevivencia", "jogos", "games"],
        newcome: "",
        format: "eBook",
        language: "portugues",
        priceRange: "",
    ...
    {
        title: "A paixão no banco dos réus",
        image: "books/apaixaonobancodosreus-luizanagibeluf.jpg",
        author: "Luiza Nagib Eluf",
        link: "https://amzn.to/4773LKj",
        topSeller: false,
        trendingBook: false,
        itemType: "book",
        genre: ["crime", "policial", "justica"],
        newcome: "",
        format: "Capa Comum",
        language: "portugues",
        priceRange: "",
        ...
        classification: "4,8",
        specialCategory: ["misteriosurbanos"], 
        description: `Esta nova edição de "A Paixão no Banco dos Réus" traz a narrativa de 17 casos de crimes de morte - 14 cometidos por homens, dois homicídios praticados por mulheres e um que permanece envolto na névoa da dúvida, o de PC Farias. Em todos os casos, o enredo da paixão. Além de relatar os fatos e a solução dada pela Justiça, que algumas vezes puniu e outras vezes perdoou os réus, o livro faz uma análise do crime passional, discutindo suas causas e circunstâncias. Examina, também, as teses normalmente apresentadas pela defesa e pela acusação no plenário do Júri, que é a instituição encarregada de julgar os crimes de homicídio.E ainda, na parte teórica da 9ª edição, foi apresentado o feminicídio e seus principais desdobramentos. O objetivo é mostrar que o amor verdadeiro não leva ao crime e que a legítima defesa da honra não pode mais ser utilizada como justificativa para o assassinato.`
    },
    {
        title: "On the Road - Pé na Estrada",
        image: "books/ontheroad-jackkerouac.jpg",
        author: "Jack Kerouac",
        link: "https://amzn.to/3ss5hI0",
        topSeller: false,
        trendingBook: false,
        itemType: "book",
        genre: ["aventura", "viagem", "auto-conhecimento"],
        newcome: "",
        format: "Capa Comum",
        language: "portugues",
        priceRange: "",
